...
<div class="container mx-auto grid md:grid-cols-2 h-full items-center justify-between overflow-x-hidden">
	<div class="px-5 h-screen w-full grid content-center space-y-10 select-none z-20">
		
		<p class="max-h-full">{content.summary}</p>

		<table transition:fade class="table-auto bg-slate-500/10">
			<tbody>
				<tr>
		...
		<div class="container">
			...
			<div class="container grid grid-flow-col w-32 h-20 items-center">
				<a href={content.links.website} target="_blank" class="w-12 shadow-sm">
					<svg class="fill-slate-400 hover:fill-black hover:bg-slate-400 w-10 h-10 p-2 rounded-[100%]" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="92px" height="92px" viewBox="0 0 92 92" enable-background="new 0 0 92 92" xml:space="preserve">
	...
	<div class="h-full w-full grid items-center justify-end absolute z-0 lg:relative">
		<div class="w-full">
			<div class="earth-img" />
		</div>
	</div>
